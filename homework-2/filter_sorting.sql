...
SELECT ship_country FROM orders WHERE ship_country = 'France' OR ship_country = 'Germany' OR ship_country = 'Spain';
...
SELECT  AVG( shipped_date - order_date) AS total FROM orders
